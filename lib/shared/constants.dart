...
import 'package:volunteer_application/shared/remote/dio.dart';
...
Future<bool> isLogin() async {
  return await checkConnection() && UserFirebase.isUserLogin();
}
...
Future<Directions?>? getSourceDestinationDistance (LatLng destination,LatLng source,)async{
  DioHelper.init();
  Directions? directions = await DioHelper.getDirections(
      destination: LatLng(destination.latitude, destination.longitude),
      origin: LatLng(source!.latitude!, source.longitude!),
      transportMean: TransportMeans.walking);
  return directions;
}
